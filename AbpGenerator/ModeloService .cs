...
namespace " + nameSpace + @"
{
    public interface I" + nomeEntidade + NomeService + @" : IApplicationService
    {
        ...
        Task<DeletarOutput> Deletar(DeletarInput input);
...
namespace " + nameSpace + @"
{
                  ...
                  @"
    {
        ...
        /// Dto vazio
        /// </returns>
        public async Task<DeletarOutput> Deletar(DeletarInput input)
        {
        ...
        public async Task<ObterTodosOutput> ObterTodos()
        {
            ...
            {
                " + nomePlural + @" = " + nomePlural.ToLower() + @".MapTo<List<ItemOutput>>()
            };
        }
    }
}";
